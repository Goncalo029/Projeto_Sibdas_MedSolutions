<?php
// apaga mesmo o equipamento (so admin)
require_once __DIR__ . '/../../../config/config.php';
require_once __DIR__ . '/../../includes/funcoes.php';
redirect_if_not_logged();
require_admin(); // apenas admin pode apagar

// guarda os filtros que estavam na lista para voltar para o mesmo sitio
$ret = $_POST['return_qs'] ?? '';
...
try {
    ...
    // vai buscar o codigo e a designacao antes de apagar (para o historico)
