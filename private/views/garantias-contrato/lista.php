  ...
  <div class="card-body">
    <div class="row g-3 align-items-end">
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="garantiasSearch" placeholder="Equipamento ou tipo..." />
      </div>
      <div class="col-md-6 text-end">
        <button class="btn btn-outline-secondary" onclick="document.getElementById('garantiasSearch').value=''; jQuery('#garantiasTable').DataTable().search('').draw();"><i class="fa-solid fa-times me-2"></i>Limpar</button>
      </div>
    </div>
  </div>
</div>
